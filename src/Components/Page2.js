        ...
        <div className='Page' id='P2cover'>
            <div className='info'>
                ...
                <div className='infoContents'>
                    ...
                    <p>- 제작 기간 : <br/><span className='textBold'>07/26 ~ 08/19</span></p>
                    <p>- 부족한 점 : <br/><span className='textBold'>미흡한 디자인, 한 화면에 과하게 압축된 인터페이스</span></p>
                    <p>
                        - 제작 후기 : <br/><span className='textBold'>처음 구상했던 것과 달리 많은 시간이 들었다.<br/>
                        A처럼 하면 되겠지? 라고 생각하면 B가 말썽이었고, 
                        이를 생각한 방식으로 수정하기가 까다로웠다. <br/>  
                        하지만 다중 쿼리문이나, 이미지 저장 등 새로운 방법을 떠
                        올려야 하는 때가 많았고, 그걸 풀어나가며<br/> 굉장히 다양한 시도를 했다. 그래서 보람차게 만족스런 결과물이 나왔다.</span> 
                    </p>
                </div>
                <div className='btns'>
